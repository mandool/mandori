...
- AI LLM 및 바이브코딩: Codex, Gemini, Claude, Antigravity를 실무에 도입하여 효율적인 업무 파이프라인 구축.
...
const THINKING_PHASES = [
    { text: '만돌이가 생각 중이에요', emoji: '💭', duration: 4000 },
    { text: '인사이트 분석 및 만돌이 포폴 뒤적거리는중', emoji: '📊', duration: 3000 },
    { text: '답변 장전 중!', emoji: '🔫', duration: 4000 },
    { text: '생각 정리한거 타이핑 중...', emoji: '⌨️', duration: 6000 },
