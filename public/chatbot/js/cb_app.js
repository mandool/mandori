...
[비즈니스 임팩트 및 주요 성과]
저는 디자인이 실제 비즈니스 수익과 성과로 직결될 때 가장 큰 보람을 느끼며, 다음과 같은 두 가지 핵심 성과를 보유하고 있습니다:
1. 신상품 유망상품 서치 및 MD 소싱요청 연계 후 프로모션 디자인: 신상품 소싱으로 연간 $600,000 이상(약 9억 원 이상)의 매출을 달성하는 직접적인 성과를 냈습니다.
2. 갤럭시 Z 플립/폴드4 및 S23 시리즈 사전예약 프로모션 수행: 2022년 KR디지털 국내 사업 매출 1위를 달성했으며, 이는 당초 목표 KPI 대비 15%를 초과 달성한 기록입니다.
- 이 외에도 이커머스 플랫폼에서 3D 기반 브랜딩을 주도하여 이벤트 랭킹을 9위에서 2위로 끌어올리는 등 데이터와 비주얼이 조화된 성과를 만들어냅니다.
